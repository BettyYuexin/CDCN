...
log_file = open(f'cross_P_{protocol_num}.txt', 'w')

print(f"cross-val-P{protocol_num}:\n ")
log_file.write(f'cross-val-P{protocol_num}:\n ')
log_file.flush()
file_name = f"CDCNpp_CASIA_FASD_cross_P{protocol_num}"

model_state_dict = torch.load(f"../CDCNpp_CASIA_FASD/CDCNpp_CASIA_FASD_400.pkl")
print(f"../CDCNpp_CASIA_FASD/CDCNpp_CASIA_FASD_400.pkl")
log_file.write(f"../CDCNpp_CASIA_FASD/CDCNpp_CASIA_FASD_400.pkl")
log_file.flush()
...
# +
model_state_dict = torch.load(f"../CDCNpp_CASIA_FASD/CDCNpp_CASIA_FASD_400.pkl", map_location={"cuda:8":"cuda:6"})
