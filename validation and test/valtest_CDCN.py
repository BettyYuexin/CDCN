...
log_file = open('validation_and_test.txt', 'w')
...
for protocol_num in range(1, 5):
    if protocol_num == 1 or protocol_num == 2:
        ...
        break
        if protocol_num == 1:
            file_name = "CDCNpp_OULU_NPU"
        else:
            file_name = "CDCNpp_OULU_NPU_P2"
            
        if not os.path.exists(f"../file_name/file_name_800.pkl"):
            model_state_dict = torch.load(f"./{file_name}/{file_name}_final.pkl")
            print(f"../{file_name}/{file_name}_final.pkl")
            log_file.write(f"../{file_name}/{file_name}_final.pkl")
            log_file.flush()
        else:
            model_state_dict = torch.load(f"../{file_name}/{file_name}_800.pkl")
            print(f"../{file_name}/{file_name}_800.pkl")
            log_file.write(f"../{file_name}/{file_name}_800.pkl")
            log_file.flush()
        ...
        for test_camera_num in range(1, 7):
            ...
            print(f"Oulu-NPU-val-P{protocol_num}-{test_camera_num}:\n ")
            log_file.write(f'Oulu-NPU-val-P{protocol_num}-{test_camera_num}:\n ')
            log_file.flush()
            file_name = f'Oulu-NPU-val-P{protocol_num}-{test_camera_num}'
