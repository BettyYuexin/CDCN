...
model_state_dict = torch.load(f"../{file_name}/{file_name}_400.pkl")
print(f"../{file_name}/{file_name}_400.pkl")
log_file.write(f"../{file_name}/{file_name}_400.pkl")
log_file.flush()
...
# +
model_state_dict = torch.load(f"../{file_name}/{file_name}_400.pkl", map_location={"cuda:7":"cuda:9"})
...
with torch.no_grad():
    ...
    for i, sample_batched in enumerate(dataloader_val):
        ...
        #pdb.set_trace()
    map_score_val_filename = './' + file_name + '_casia_map_score_val.txt'
    ...
    map_score_test_filename = './' + file_name + '_casia_map_score_test.txt'
